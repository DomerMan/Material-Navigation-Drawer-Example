...
public class ActionBarDrawerToggle extends android.support.v4.app.ActionBarDrawerToggle
 {
    ...
    protected DrawerArrow mDrawerImage;
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, DrawerArrow drawerImage, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
